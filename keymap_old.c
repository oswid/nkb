...
[_CYRILIC] = LAYOUT( \
  ...
  MY_WIN,  XXXXXXX, ADJUST,  MY_CTRL, MY_LOW,  Sp_lS,       Sp_rS ,  MY_RAISE,A_HD,    XXXXXXX, XXXXXXX, XXXXXXX \
),
...
[_TELHK] =  LAYOUT( \
  ...
  XXXXXXX, XXXXXXX, XXXXXXX, CT_DOWN, CT_UP,   XXXXXXX,	    C(KC_K), CT_1,    CT_2,    CT_3,    C_F20,   C_F23,\
...
bool controlSpaceChangeLang = false;
